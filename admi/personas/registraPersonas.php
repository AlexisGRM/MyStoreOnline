<?php 
	...
	if(isset($_POST["btnEnviar"])){
		...
		$sql = "INSERT INTO personas(nombre, apellidoPaterno,apellidoMaterno, domicilio, telefono,correo)value('$nombre','$apellidoPaterno','$apellidoMaterno','$domicilio','$telefono','$correo')";
		$sql2= "INSERT INTO sesion(username,password)value('$username','$password')";
		...
		<div class="panel-body">
			<form method="POST" class="form-horizontal" role="form">
				...
				<div class="form-group">
			      ...
			      <div class="col-sm-11">
			        <input type="text" class="form-control" id="Apellido" name="apellidoPaterno" placeholder="Apellido Paterno" required>
			      </div>
			    </div>
				<div class="form-group">
			      <label class="control-label col-sm-1" for="email">Apellido Materno:</label>
			      <div class="col-sm-11">
			        <input type="text" class="form-control" id="Apellido" name="apellidoMaterno" placeholder="Apellido Materno" required>
			      </div>
			    </div>
			    ...
			    <div class="form-group">
			     ...
			     <div class="form-group">
			      ...
			      <div class="col-sm-11">
			        <input type="password" class="form-control" id="ConfirmaContraseña" name="confirmaContraseña" required>
			      </div>
			    </div>
